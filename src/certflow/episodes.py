...
def planner_config(config: ExperimentConfig) -> PlannerConfig:
    return PlannerConfig(
        ...
        cia_ub=config.cia_ub,
        cia_ub_alpha_fraction=config.cia_ub_alpha_fraction,
        age_stratify=config.age_stratify,
        age_bins=config.age_bins,
        hybrid_sensing=config.hybrid_sensing,
        refine_after_certify=config.refine_after_certify,
        rho_mode=config.rho_mode,
        adaptive_rate=config.adaptive_rate,
        decision_uniform=config.decision_uniform,
        recovery_formal=config.recovery_formal,
        selection_conditional=config.selection_conditional,
        selection_audit_min=config.selection_audit_min,
        evidence_model=config.evidence_model,
        evidence_model_min_calibration=config.evidence_model_min_calibration,
        decision_risk_target=config.decision_risk_target,
        decision_risk_delta=config.decision_risk_delta,
        trajectory_tubes=config.trajectory_tubes,
        trajectory_min_calibration=config.trajectory_min_calibration,
        active_sensing=config.active_sensing,
        active_sensing_exploration=config.active_sensing_exploration,
        regime_recovery=config.regime_recovery,
        recovery_alarm_delta=config.recovery_alarm_delta,
        recovery_samples=config.recovery_samples,
        recovery_evidence_threshold=config.recovery_evidence_threshold,
        recovery_betting_epsilons=config.recovery_betting_epsilons,
    )
